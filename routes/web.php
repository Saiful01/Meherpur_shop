...
//Extra Pages
Route::get('/about', '...and receive $20 coupon for first shopping.@about');
...
Route::get('/cart/page', 'HomeController@cartView');
Route::get('/cart/checkout', 'HomeController@cartCheckout');
...
//    $category = Categor/product/category/{{$category->category_id}}y::orderBy('created_at', 'ASC')->get();
//
//    return view('ecommerce.pages.product.newview')->with('categories',$category);
//
//});
