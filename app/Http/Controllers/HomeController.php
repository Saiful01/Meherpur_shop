...
class HomeController extends Controller
{
    ...
    {
        $featured_item = Product::where('featured_product', true)->where('publish_status', true)->limit(1)->get();
        $featured_products = Product::where('featured_product', true)->where('publish_status', true)->limit(6)->get();

        $new_products = Product::orderBy('product_id', 'DESC')->where('publish_status', true)->limit(3)->get();
        $new_products2 = Product::orderBy('product_id', 'DESC')->where('publish_status', true)->limit(3)->get();

        $category = Category::orderBy('created_at', 'ASC')->get();
        $category_show = Category::orderBy('created_at', 'ASC')->limit(4)->get();
        $slider = Slider::get();
        ...
        return view('ecommerce.pages.home.index')
            ...
            ->with('new_products2', $new_products2);
    ...
    public function search(Request $request)
    {
        ...
        return view('ecommerce.pages.product.search')->with('products', $product)->with('categories', $category);
    ...
    {
        $category = Category::all();
        return view('ecommerce.pages.cart.index')->with('categories', $category);
    ...
    {
        $category = Category::all();
        return view('ecommerce.pages.cart.checkout')->with('categories', $category);
